...
namespace DAL
{
    ...
    public class DataAccess
    {
        ...
        public static void UpdateEmp(int IDNV, string TENV, DateTime NGSINH, string GIOITINH, string DIACHI, string Email, string DiDong, string VanHoa, string ChuyenMon, int IDPB, int Luong)
        {
            SqlConnection conn = ConnectionData.Connect();
            conn.Open();
